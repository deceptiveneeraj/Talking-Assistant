...
def TrainTasks():
    ...
    with open("C:\\Users\\neera\\PycharmProjects\\AI Friday\\NN_ML_AI_NLP_DL\\Tasks.json", 'r') as f:
        intents = json.load(f)
    ...
    FILE = "C:\\Users\\neera\\PycharmProjects\\AI Friday\\NN_ML_AI_NLP_DL\\Tasks.pth"
...
def TasksExecutor(query):
    ...
    with open('C:\\Users\\neera\\PycharmProjects\\AI Friday\\NN_ML_AI_NLP_DL\\Tasks.json', 'r') as json_data:
